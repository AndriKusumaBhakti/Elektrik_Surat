...
public abstract class TaskJenisSurat extends AsyncTask<RequestJenisSurat, Void, Boolean> {
    private Context context;
    private ResponseJenisSurat response;
    private RestAdapter restAdapter;
    private String errorMessage;

    public TaskJenisSurat(Context context){
    ...
    protected Boolean doInBackground(RequestJenisSurat... requests) {
        ...
        try{
            response = methods.jenisSurat(output);
    ...
    protected abstract void onSuccess(ResponseJenisSurat response);
