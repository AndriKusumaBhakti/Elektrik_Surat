...
public class FragmentScanQrPenduduk extends BaseFragment{
    ...
    public FragmentScanQrPenduduk() {}

    public static FragmentScanQrPenduduk newInstance() {
        return newInstance("","");
    }

    public static FragmentScanQrPenduduk newInstance(String param1, String param2) {
